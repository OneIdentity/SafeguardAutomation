; ONLY FOR DEMO USE
; Created to work with SPS 6.11 or older.

; Compile with Aut2exe to ensure the include files are added too
; cmd line arguments for launcher: OI-SG-RemoteApp-Launcher.exe --cmd <path>\web_SPS_pre_6.12.exe --args {username} {password} {asset}
